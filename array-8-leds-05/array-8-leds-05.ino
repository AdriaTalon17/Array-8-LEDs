...
{
{
  ...
  digitalWrite(led6, LOW);    // posar a 5V el pin 10
...
}
{
  ...
  digitalWrite(led6, LOW);    // posar a 5V el pin 10
  digitalWrite(led7, LOW);    // posar a 5V el pin 10
  delay(150);                  // es queden leds 500ms apagats
}
{
  digitalWrite(led0, LOW);    // posar a 5V el pin 5
  digitalWrite(led1, LOW);    // posar a 5V el pin 6
...
}
{
  ...
  digitalWrite(led7, LOW);    // posar a 5V el pin 10
  delay(350);                  // es queden leds 500ms apagats
}

{
  ...
  digitalWrite(led5, LOW);    // posar a 5V el pin 10
  digitalWrite(led6, LOW);    // posar a 5V el pin 10
  digitalWrite(led7, HIGH);    // posar a 5V el pin 10
  delay(400);                  // es queden leds 500ms apagats
}
}
